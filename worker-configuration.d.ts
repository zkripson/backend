/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5918bd5bad2620fc52d0d136e13d172b)
// Runtime types generated with workerd@1.20250424.0 2025-04-01 durable_object_alarms
declare namespace Cloudflare {
	interface Env {
		NETWORK: string;
		BASE_SEPOLIA_RPC_URL: string;
		BASE_SEPOLIA_ID: string;
		BASE_RPC_URL: string;
		BASE_ID: string;
		...
		AUTO_DISTRIBUTE_REWARDS: string;
		REWARD_DISTRIBUTION_DELAY_MS: string;
		RATE_LIMIT_PER_MINUTE: string;
		ADMIN_ACCESS_TOKEN: string;
		ENABLE_DEBUG_LOGS: string;
		MOCK_CONTRACT_INTERACTIONS: string;
		TEST_PLAYER_1: string;
		TEST_PLAYER_2: string;
		CONTRACT_RETRY_COUNT: string;
		GAS_LIMIT_MULTIPLIER: string;
		MAX_REWARD_BATCH_SIZE: string;
		SESSION_CLEANUP_INTERVAL_HOURS: string;
		ENABLE_REQUEST_TRACKING: string;
		SLOW_REQUEST_THRESHOLD: string;
		ERROR_WEBHOOK_URL: string;
		GAME_SESSIONS: DurableObjectNamespace<import("./src/index").GameSession>;
		PLAYER_PROFILES: DurableObjectNamespace<import("./src/index").PlayerProfile>;
		INVITE_MANAGER: DurableObjectNamespace<import("./src/index").InviteManager>;
	}
}
